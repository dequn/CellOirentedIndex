            ...
            while (compareNum < this.pois.size()) {
                ...
                for (int j = 0; j < 10; j++) {
                    ...
                    for (int i = 0; i < compareNum; i++) {
                        ...
                        Building.queryCell(building.getFloor(poi.getFloorNum()), poi, POI.QueryMethod.Grid);
                    }
                    ...
                    for (int i = 0; i < compareNum; i++) {
                        POI poi = this.pois.get(i);
                        Building.queryCell(building.getFloor(poi.getFloorNum()), poi, POI.QueryMethod.STR);
                    }
